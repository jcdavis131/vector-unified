"""Face-validity probe: do unified_market.pt salary/award heads rank known stars?

Loads unified_market.pt + market_cultural.json, encodes full corpus, scores
salary_head and award_head on z. Reports:
  - Spearman corr of pred vs label on labeled rows (per sport + pooled)
  - Top-10 predicted salary / award prestige (should surface Forbes/MVP names)
