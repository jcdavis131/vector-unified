...
<!-- merged from outside edits 2026-08-14T12:37Z -->
| scout-mlops-unified-dfs | vector-unified / G2 0.685→0.642 MTL [8,18,33,12] UW+GradNorm α0.8+PCGrad136 GRL λ0.3→0.5 | 07:35 CT | Lane5 UNIFIED transfer swarm T5_h146 g2_control 0.7087 treated 0.6236 Δ-0.0851 p0.0251 CI95[-0.1527,-0.0174] floor0.6258 rank12.4 sil0.683 G4 0.9828 vs0.1712 Phase1_only gates FAIL_pending LOCAL-GPU → stay 0.642 sim code_changes_live__full_data_missing_on_VM MTL 8/18/33/12 DFS 12 Kelly0.25/1% chimera 20719×64-d gap4831 honest | scout/mlops-unified-dfs-20260814 | claimed |
| hillclimb-loop | vector-gridiron / DFS v7 32-d weather+Vegas | 07:39 CT | Lane 2 GRIDIRON independent DFS MTNN swarm weather+Vegas 32-d native MAE 4.268->3.948 Sharpe1.002 stdlib smoke salary-snap closing risk PPR ITT wind-2% | scout/mlops-gridiron-dfs-20260814 | claimed |
| scout-mlops-pitch-dfs | vector-pitch / MTNN v7 24-d 0.797 8-d DFS Statcast | 07:36 CT | Lane 3 PITCH independent MTNN Statcast 2295×9 24-d 0.797→0.784 compact -36% DK sub-linear 3*TB-1*2B-1*3B-2*HR R²0.92×1.07 hand LHB+28 RHB+16 park Coors1.25-1.367 GABP1.263-1.379 Yankee1.19 Oracle0.60-0.78 salary 2.0+2.8ln+1.1team+order+park+hand 1.15→0.68 MAE 3.92→3.6207 Sharpe0.94 MoMA rank12 SupCon0.07 collectors fpl-salary/form-minutes/injury-market dfs_harvest_pitch.jsonl 09m zero-deps | scout/mlops-pitch-dfs-20260814 | claimed |
| scout-mlops-equities-dfs | vector-equities / MTNN v7 66 feats peer drift 17×27 | 07:36 CT | Lane 4 EQUITIES independent peer drift 66 feats 200k CIK IC 0.007→0.174 13F crowding 0.6HF+0.3n5+0.1HFcnt/sqrt(N) fade -z Form4 CEO/CFO3.0 exp(-Δ/90) triple-barrier 10%/-7% 63d asym1.43:1 Kelly0.25 1% max full1.37 DD35%→8-10% EQUITY_ROI=(12m_fwd-sector_median)/vol MAE 0.0185→0.016009 Sharpe1.135 threats survivorship30% GICS PIT distress-0.2624 collectors def14a-clock/13F-ownership/triple-barrier-Kelly dfs_harvest_equities.jsonl 11m zero-deps | scout/mlops-equities-dfs-20260814 | claimed |
